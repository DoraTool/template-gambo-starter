...
export class Level2Scene extends BaseLevelScene {
  ...
  create() {
    ...
    // Play background music (reuse the same music)
  ...
  createPlayer() {
    ...
    this.player = new GundamPlayer(this, 2 * 64, 18 * 64)
  }
  ...
  createEnemies() {
    ...
    // Enemy on left stair platform middle layer
    const enemy1 = new ZakuEnemy(this, 5 * 64, 12 * 64)
    this.enemies.add(enemy1)
    
    // Enemy on central floating platform
    const enemy2 = new ZakuEnemy(this, 15 * 64, 12 * 64)
    this.enemies.add(enemy2)
    
    // Enemy on right high platform
    const enemy3 = new ZakuEnemy(this, 25 * 64, 8 * 64)
    this.enemies.add(enemy3)
    
    // Enemy on top small platform
    const enemy4 = new ZakuEnemy(this, 15 * 64, 4 * 64)
  ...
  createDecorations() {
    ...
    const controlPanel1 = this.add.image(3 * 64, 15 * 64, 'space_control_panels_variant_1')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(controlPanel1)
    
    const controlPanel2 = this.add.image(7 * 64, 9 * 64, 'space_control_panels_variant_2')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(controlPanel2)
    
    // Add containers
    const container1 = this.add.image(10 * 64, 18 * 64, 'space_containers_variant_1')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(container1)
    
    const container2 = this.add.image(27 * 64, 14 * 64, 'space_containers_variant_2')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(container2)
    
    // Add pipes
    const pipe1 = this.add.image(12 * 64, 12 * 64, 'space_pipes_variant_1')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(pipe1)
    
    const pipe2 = this.add.image(22 * 64, 8 * 64, 'space_pipes_variant_1')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(pipe2)
    
    // Add antennas
    const antenna1 = this.add.image(6 * 64, 12 * 64, 'space_antennas_variant_1')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(antenna1)
    
    const antenna2 = this.add.image(16 * 64, 4 * 64, 'space_antennas_variant_1')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(antenna2)
    
    // Add energy cores
    const energyCore1 = this.add.image(20 * 64, 18 * 64, 'space_energy_cores_variant_1')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(energyCore1)
    
    const energyCore2 = this.add.image(28 * 64, 8 * 64, 'space_energy_cores_variant_1')
      .setOrigin(0.5, 1)
      .setScale(decorationScale)
    this.decorations.add(energyCore2)
  }
}
